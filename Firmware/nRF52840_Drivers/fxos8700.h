...
int32_t fxos8700_idle_mode_enable(uint8_t sensors);
int32_t fxos8700_active_mode_enable(uint8_t sensors);

int32_t fxos8700_acc_apply_setting(uint8_t setting);
int32_t fxos8700_gyr_apply_setting(uint8_t setting);
