...
/**
 * @file fxos8700_regdef.h
 * @brief This header file file contains the register definitions for FXOS8700, the 6-axis sensor
 *        with integrated linear accelerometer and magnetometer.
 */

#ifndef FXOS8700_REGDEF_H_
#define FXOS8700_REGDEF_H_

#include <stdint.h>
/**
 * @brief FXOS8700 register addresses map explained in section 14 of the FXOS8700 data sheet.
 * @see   Table 16: https://www.nxp.com/files-static/sensors/doc/data_sheet/FXOS8700CQ.pdf
 */
enum {
